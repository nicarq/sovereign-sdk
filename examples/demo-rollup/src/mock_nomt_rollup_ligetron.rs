...
/// Rollup with a [`ConfigurableSpec`] with [`MockDaSpec`] as Da spec, [`Ligetron`] inner vm and [`MockZkvm`] for outer vm
#[derive(Default)]
pub struct MockNomtDemoRollupLigetron<M> {
...
pub type MockNomtRollupSpecLigetron<M> = ConfigurableSpec<
    MockDaSpec,
    Ligetron,
    MockZkvm,
    MultiAddressEvm,
...
impl RollupBlueprint<Native> for MockNomtDemoRollupLigetron<Native>
where
    MockNomtRollupSpecLigetron<Native>: PluggableSpec,
    <MockNomtRollupSpecLigetron<Native> as Spec>::Address: FromVmAddress<EthereumAddress>,
{
    type Spec = MockNomtRollupSpecLigetron<Native>;
    type Runtime = Runtime<Self::Spec>;
}

impl RollupBlueprint<WitnessGeneration> for MockNomtDemoRollupLigetron<WitnessGeneration>
where
    MockNomtRollupSpecLigetron<WitnessGeneration>: PluggableSpec,
    <MockNomtRollupSpecLigetron<WitnessGeneration> as Spec>::Address: FromVmAddress<EthereumAddress>,
{
    type Spec = MockNomtRollupSpecLigetron<WitnessGeneration>;
    type Runtime = Runtime<Self::Spec>;
}

#[async_trait]
impl FullNodeBlueprint<Native> for MockNomtDemoRollupLigetron<Native> {
    ...
    async fn create_prover_service(
        ...
        let inner_vm = LigetronHost::from_args(&host_args);
