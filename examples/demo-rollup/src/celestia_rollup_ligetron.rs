...
/// Rollup with CelestiaDa (Ligetron inner VM)
#[derive(Default)]
pub struct CelestiaDemoRollupLigetron<M> {
    phantom: std::marker::PhantomData<M>,
}

type CelestiaRollupSpecLigetron<M> =
    ConfigurableSpec<CelestiaSpec, Ligetron, MockZkvm, MultiAddressEvm, M>;

impl RollupBlueprint<Native> for CelestiaDemoRollupLigetron<Native>
where
...
impl RollupBlueprint<WitnessGeneration> for CelestiaDemoRollupLigetron<WitnessGeneration>
where
...
#[async_trait]
impl FullNodeBlueprint<Native> for CelestiaDemoRollupLigetron<Native> {
    type DaService = CelestiaService;

    type StorageManager =
        NativeStorageManager<CelestiaSpec, <CelestiaRollupSpecLigetron<Native> as Spec>::Storage>;
...
impl WalletBlueprint<Native> for CelestiaDemoRollupLigetron<Native> {}
