...
pub struct Args {
    ...
    /// How many non-setup transactions should be generate by bank module
    #[arg(long)]
    pub bank_transactions_count: u64,

    /// To bootstrap account pool.
    #[arg(long)]
    pub private_keys_dir: String,
    ...
    pub celestia_batch_namespace: String,
...
impl Args {
    pub fn get_namespace(&self) -> anyhow::Result<Namespace> {
