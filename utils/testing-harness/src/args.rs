...
pub struct Args {
    ...
    /// How many non-setup bank transfer transactions should be generated by bank module
    #[arg(long)]
    pub bank_transactions_count: u64,

    /// How many token contracts should be generated by bank module
    #[arg(long)]
    pub token_contracts_count: Option<u64>,
