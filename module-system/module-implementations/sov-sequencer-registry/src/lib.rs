...
pub(crate) struct AllowedSequencer<C: Context> {
    /// The rollup address of the sequencer.
    pub rollup_address: C::Address,
...
pub struct SequencerRegistry<C: Context, Da: sov_modules_api::DaSpec> {
    ...
    #[state]
    pub(crate) allowed_sequencers: StateMap<Da::Address, AllowedSequencer<C>, BcsCodec>,
    ...
    /// allowed to exit.
    #[state]
    pub(crate) coins_to_lock: StateValue<Coins<C>>,
}
...
impl<C: Context, Da: sov_modules_api::DaSpec> sov_modules_api::Module for SequencerRegistry<C, Da> {
    type Context = C;
