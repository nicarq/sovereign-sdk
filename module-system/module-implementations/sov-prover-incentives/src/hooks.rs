...
/// The [`ProverIncentives::reserve_gas`] and [`ProverIncentives::refund_remaining_gas`] are used to lock transaction base gas
/// to the incentives module so that the provers can be rewarded for their work.
/// These methods are the zk-execution equivalent of the ones in `AttesterIncentives`.
