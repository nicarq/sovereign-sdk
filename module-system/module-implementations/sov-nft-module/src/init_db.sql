...
-- Create index on collection_id to quickly find NFTs belonging to a particular collection
CREATE INDEX idx_nft_collection ON nfts (collection_id);
...
-- Create index on collection_id to quickly find top owners in a particular collection
CREATE INDEX idx_top_owners_collection ON top_owners (collection_id);
